  ...
  return (
    <footer className={classes.footer}>
      ...
      <Typography variant="subtitle1" align="center" color="textSecondary" component="p" style={{ fontFamily: "Quicksand, sans-serif", color: "white", fontSize: "17.5px" }}>
        Email : <a href="mailto: wearohh@gmail.com" style={{ color: "white" }}>wearohh@gmail.com</a>
      </Typography>
      <Typography variant="subtitle1" align="center" color="textSecondary" component="p" style={{ fontFamily: "Quicksand, sans-serif", color: "white", fontSize: "17.5px" }}>
        Phone : +91 9019496469
      </Typography>
      <div style={{ textAlign: "center", marginBottom: "10px" }}>
        ...
        <a href="https://www.instagram.com/wearoh1/" style={{ color: "inherit", margin: "5px" }}><InstagramIcon /></a>
